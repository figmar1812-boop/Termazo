  ...
  return (
    <section className="px-6 md:px-10 py-24 bg-hueso border-b border-grafito/10">
      <div className="mx-auto max-w-7xl">
        <span className="eyebrow text-cobre-dim font-bold mb-4">Nuestros termos</span>
        <h2 className="font-display font-medium text-3xl md:text-4xl max-w-xl mb-14 uppercase">
          Elige tu Termazo.
        </h2>
