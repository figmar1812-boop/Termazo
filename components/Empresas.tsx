    ...
    <section className="px-6 md:px-10 py-24 bg-grafito text-hueso border-b border-hueso/10">
      <div className="mx-auto max-w-7xl grid md:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <h2 className="font-display font-medium text-3xl md:text-4xl mb-4 uppercase leading-[1.05]">
            Tu marca.
            <br />
            En cada Termazo.
          </h2>
          <p className="text-plata max-w-md">
            Termos personalizados para equipos, eventos, clientes y regalos
            corporativos. Pedidos desde 10 piezas con tu logo grabado.
          </p>
        </div>
