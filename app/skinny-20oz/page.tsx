...
const SLUG = "skinny-20oz";

export const dynamic = "force-dynamic";

export const metadata: Metadata = {
  title: "Skinny 20 oz personalizado con grabado láser | Termazo",
  description:
    "Personaliza tu Skinny 20 oz con tu nombre, frase o logo. Grabado láser real, vista previa antes de comprar.",
};
...
export default async function Skinny20oz() {
