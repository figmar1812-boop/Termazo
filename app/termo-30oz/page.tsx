...
const SLUG = "termo-30oz";

export const dynamic = "force-dynamic";

export const metadata: Metadata = {
  title: "Termo 30 oz personalizado con grabado láser | Termazo",
  description:
    "Personaliza tu Termo 30 oz con tu nombre, frase o logo. Grabado láser real, vista previa antes de comprar.",
};
...
export default async function Termo30oz() {
